...
china_rounded = 123
china_exact = 122.5
print("china_name=",china_name ,"china_rounded=",china_rounded,"china_exact=",china_exact)
...
#china variable assignment
china = 123
#india variable assignment
india = 124
#Untied_states variable assignment
united_states = 134
...
temperatures_slice=temperatures[len(temperatures)-3:]